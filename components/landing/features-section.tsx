...
function AIVisual() {
  return (
    <svg viewBox="0 0 200 160" className="w-full h-full">
      ...
      {(() => {
        const radius = 50;
        const cosVals = [1, 0.5, -0.5, -1, -0.5, 0.5];
        const sinVals = [0, 0.8660254037844386, 0.8660254037844386, 0, -0.8660254037844386, -0.8660254037844386];
        return [0, 1, 2, 3, 4, 5].map((i) => {
          const x = 100 + cosVals[i] * radius;
          const y = 80 + sinVals[i] * radius;
          return (
            <g key={i}>
              {/* Connection line */}
