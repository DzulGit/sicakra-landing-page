...
const words = ["keluarga", "bekerja", "belajar", "hiburan", "bisnis"];
    ...
    <section className="relative min-h-screen flex flex-col justify-center overflow-hidden">
      ...
      <div className="relative z-10 max-w-[1400px] mx-auto px-6 lg:px-12 py-32 lg:py-40">
        ...
        <div className="mb-12">
          ...
          >
            <span className="block">Internet cepat</span>
        ...
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-24 items-end">
          ...
          >
            Tinggalkan internet lemot dan kuota terbatas.
            Nikmati Wi-Fi cepat, stabil, dan 100% Unlimited untuk rumah dan bisnismu.
          </p>
        ...
        <div className="flex gap-16 marquee whitespace-nowrap">
          {[...Array(2)].map((_, i) => (
            <div key={i} className="flex gap-16">
              {[
                { value: "100%", label: "Infrastruktur Fiber Optik", company: "TECHNOLOGY" },
                { value: "24 Jam", label: "SLA Penyelesaian Masalah", company: "SUPPORT" },
                { value: "1:1", label: "Kecepatan Simetris Penuh", company: "PERFORMANCE" },
                { value: "Unlimited", label: "Bebas Kuota Sepuasnya", company: "BENEFIT" },
              ].map((stat) => (
